...
export const finances = {
  ...
  goals: {
    ...
    update: async (params: UpdateGoalParams) => {
      ...
      await api.PATCH(`/finances/spaces/${spaceId}/goals/${id}`, data)
